	...
	return []PullRequest{
		{
			...
			State:        "open",
			Body:         "This PR adds a new feature for processing data more efficiently",
			URL:          "https://github.com/test/repo/pull/1234",
			CreatedAt:    lastWeek,
			UpdatedAt:    now,
			Author:       User{Login: "alice", Type: "User"},
			BaseRef:      "main",
			HeadRef:      "feature/data-processing",
			BaseSHA:      "abc123",
			HeadSHA:      "def456",
			Additions:    150,
			Deletions:    20,
		...
		},
		{
			...
			State:          "closed",
			Body:           "Fixes a memory leak that was causing OOM errors",
			URL:            "https://github.com/test/repo/pull/1233",
			CreatedAt:      lastWeek,
			UpdatedAt:      yesterday,
			ClosedAt:       &yesterday,
			MergedAt:       &merged,
			Author:         User{Login: "bob", Type: "User"},
			MergedBy:       &User{Login: "maintainer", Type: "User"},
			BaseRef:        "main",
			HeadRef:        "fix/memory-leak",
			BaseSHA:        "abc123",
			HeadSHA:        "ghi789",
			MergeCommitSHA: "jkl012",
			Additions:      10,
			Deletions:      5,
			ChangedFiles:   2,
			Comments:       5,
		...
		},
		{
			...
			State:        "open",
			Body:         "Updates the README with new examples",
			URL:          "https://github.com/test/repo/pull/1232",
			CreatedAt:    yesterday,
			UpdatedAt:    yesterday,
			Author:       User{Login: "charlie", Type: "User"},
			BaseRef:      "main",
